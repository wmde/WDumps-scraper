...
def make_mock_session(mocker: MockerFixture) -> Callable[..., MagicMock]:
    def factory(status_code: int = 200, text: str = "<p>Hello</p>") -> MagicMock:
...
def test_get_returns(make_mock_session: Callable[..., MagicMock]) -> None:
...
def test_get_raises(make_mock_session: Callable[..., MagicMock]) -> None:
